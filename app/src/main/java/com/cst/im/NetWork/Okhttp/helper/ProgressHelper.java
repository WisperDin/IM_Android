...
//                //包装响应体并返回
//                return originalResponse.newBuilder()
//                        .body(new ProgressResponseBody(originalResponse.body(), uiImRequest))
//                        .build();
//            }
//        };
//        return client.newBuilder()
