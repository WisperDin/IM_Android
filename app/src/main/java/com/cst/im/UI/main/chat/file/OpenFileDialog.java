package com.cst.im.UI.main.chat.file;
...
public class OpenFileDialog {
    ...
    public static Dialog createDialog(int id, Context context, String title, CallbackBundle callback, String suffix, Map<String, Integer> images){
        ...
        //获取内部存储路径
        //sRoot = context.getFilesDir().getPath();
    ...
    static class FileSelectView extends ListView implements OnItemClickListener{
        ...
        private int refreshFileList()
        {
            ...
            SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.filedialog_item, new String[]{"img", "name", "path"}, new int[]{R.id.filedialogitem_img, R.id.filedialogitem_name, R.id.filedialogitem_path});
