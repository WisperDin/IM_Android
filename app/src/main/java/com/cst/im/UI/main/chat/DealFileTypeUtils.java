...
public class DealFileTypeUtils {
    public static String[] dealFileTypeUtils = new String[]{"apk", "avi", "bmp", "chm", "dll", "doc", "docx", "dos", "gif", "html", "jpeg", "jpg", "movie", "mp3", "dat", "mp4", "mpe", "mpeg", "mpg", "pdf", "png", "ppt", "pptx", "rar", "txt", "wav", "wma", "wmv", "xls", "xlsx", "xml", "zip"};

    public DealFileTypeUtils() {
    }
    ...
    public static File[] loadFiles(File var0) {
        ...
        DealFileTypeUtils.MyComparator var6 = new DealFileTypeUtils.MyComparator();
    ...
    public static void openFile(Uri var0, String var1, Activity var2) {
        ...
        try {
            ...
            var5.printStackTrace();
            Toast.makeText(var2, "没有找到打开此类文件的程序", Toast.LENGTH_SHORT).show();
        }
